...
const Footer = () => {
    ...
    return <Row className="footer" key={3}>
        <div className="col-md-4">
            ...
            <strong className="centered"><a href="http://guides.grails.org" target="_blank" rel="noopener noreferrer">Grails
                Guides</a></strong>
            <p>Building your first Grails app? Looking to add security, or create a Single-Page-App? Check out the <a
                href="http://guides.grails.org" target="_blank" rel="noopener noreferrer">Grails Guides</a> for
        ...
        <div className="col-md-4">
            ...
            <strong className="centered"><a href="http://docs.grails.org" target="_blank"
                                            rel="noopener noreferrer">Documentation</a></strong>
        ...
        <div className="col-md-4">
            ...
            <strong className="centered"><a href="https://grails-slack.cfapps.io" target="_blank"
                                            rel="noopener noreferrer">Join the
                Community</a></strong>
